...
namespace SE
{
    public partial class AdminPending : System.Web.UI.Page
    {

        protected void Page_Load(object sender, EventArgs e)
        {
            DatabaseDriver driver = new DatabaseDriver();
            DataTable dt = driver.getAdminPending();
        ...
        protected void ApproveRequest_Click(object sender, CommandEventArgs e)
        {
            ...
            int id = Convert.ToInt32(e.CommandArgument.ToString());
            DatabaseDriver driver = new DatabaseDriver();
            driver.setAdminRequest(id, 1, remarks);
        ...
        protected void DisapproveRequest_Click(object sender, CommandEventArgs e)
        {
            ...
            int id = Convert.ToInt32(e.CommandArgument.ToString());
            DatabaseDriver driver = new DatabaseDriver();
            driver.setAdminRequest(id, 2, remarks);
            Page.Response.Redirect(Page.Request.Url.ToString(), true);
        }
    }
}