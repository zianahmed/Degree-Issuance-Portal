<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentRequest.aspx.cs" Inherits="SE.StudentRequest" %>
...
<body>
    ...
    <div class="mainbg">
        <form class="f1" runat="server">
            ...
            <asp:TextBox class="e1" ID="errorLabel" runat="server" name="error" type="text"></asp:TextBox>
            </div>
            <asp:Button class="b1" ID="Button1" runat="server" Text="SUBMIT FORM" BorderStyle="Solid" OnClick="Submit_button"/>
        </form>
    </div>
</body>
</html>
