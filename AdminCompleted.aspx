<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminCompleted.aspx.cs" Inherits="SE.AdminCompleted" %>
        ...
        <div class="main">
            ...
            <div class="mainbg">
                <div class="f1">
                    ...
                    <br />
                   <asp:GridView style="margin-left: 100px" ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="15" OnRowDataBound = "GridView1_RowDataBound">
                        <Columns>
